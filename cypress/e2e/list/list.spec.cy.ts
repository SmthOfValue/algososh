...
describe('Отрисовка дефолтного списка', function() {
    ...
    it('Список корректно отрисован', function() {        
        ...
        cy.get('p[class*="circle_letter"]').eq(2).as('element3');
        cy.get('p[class*="circle_letter"]').eq(3).as('element4');
        ...
        cy.get('li[class*="list-page_item"]').eq(0).as('item1');
        cy.get('li[class*="list-page_item"]').eq(3).as('item4');

        cy.get('p[class*="circle_index"]').eq(0).should('have.text', '0');
        cy.get('p[class*="circle_index"]').eq(1).should('have.text', '1');
        cy.get('p[class*="circle_index"]').eq(2).should('have.text', '2');
        cy.get('p[class*="circle_index"]').eq(3).should('have.text', '3');
        ...
        cy.get('@item4').find('div[class*="circle_tail"]').should('exist');
    });
});
...
describe('Добавление элемента в head', function() {
    ...
    it('Элемент корректно добавляется в head', function() {
        ...
        cy.get('li[class*="list-page_item"]').eq(0).as('item1');
        cy.get('@item1').find('div[class*="circle_small"]').should('exist');
        cy.get('div[class*="circle_small"]').should('have.css', 'border', '4px solid rgb(210, 82, 225)')
        cy.get('div[class*="circle_small"]').find('p[class*="circle_letter"]').should('have.text', '2');

        cy.wait(400);

        cy.get('div[class*="circle_circle"]').eq(0).should('have.css', 'border', '4px solid rgb(127, 224, 81)')

        cy.get('p[class*="circle_letter"]').eq(0).as('element1');
        cy.get('p[class*="circle_letter"]').eq(1).as('element2');
        cy.get('p[class*="circle_letter"]').eq(2).as('element3');
        cy.get('p[class*="circle_letter"]').eq(3).as('element4');
        cy.get('p[class*="circle_letter"]').eq(4).as('element5');

        cy.get('li[class*="list-page_item"]').eq(0).as('item1');
        cy.get('li[class*="list-page_item"]').eq(4).as('item5');

        cy.get('p[class*="circle_index"]').eq(0).should('have.text', '0');
        cy.get('p[class*="circle_index"]').eq(1).should('have.text', '1');
        cy.get('p[class*="circle_index"]').eq(2).should('have.text', '2');
        cy.get('p[class*="circle_index"]').eq(3).should('have.text', '3');
        cy.get('p[class*="circle_index"]').eq(4).should('have.text', '4');
        ...
        cy.get('@item1').find('div[class*="circle_head"]').should('exist');
        cy.get('@item5').find('div[class*="circle_tail"]').should('exist');
...
describe('Добавление элемента в tail', function() {
    ...
    it('Элемент корректно добавляется в tail', function() {
        ...
        cy.get('li[class*="list-page_item"]').eq(3).as('item4');
        cy.get('@item4').find('div[class*="circle_small"]').should('exist');
        cy.get('div[class*="circle_small"]').should('have.css', 'border', '4px solid rgb(210, 82, 225)');
        cy.get('div[class*="circle_small"]').find('p[class*="circle_letter"]').should('have.text', '2');

        cy.wait(400);

        cy.get('div[class*="circle_circle"]').eq(4).should('have.css', 'border', '4px solid rgb(127, 224, 81)')
...
describe('Добавление элемента по индексу', function() {
    ...
    it('Элемент корректно добавляется по индексу', function() {
        ...
        cy.get('@item1').find('div[class*="circle_small"]').should('exist');
        cy.get('div[class*="circle_small"]').should('have.css', 'border', '4px solid rgb(210, 82, 225)');
        cy.get('div[class*="circle_small"]').find('p[class*="circle_letter"]').should('have.text', '44');

        cy.wait(400);

        cy.get('@item1').find('div[class*="circle_small"]').should('not.exist');

        cy.get('div[class*="circle_circle"]').eq(0).should('have.css', 'border', '4px solid rgb(210, 82, 225)')

        cy.get('li[class*="list-page_item"]').eq(1).as('item2');
        cy.get('@item2').find('div[class*="circle_small"]').should('exist');
        cy.get('div[class*="circle_small"]').should('have.css', 'border', '4px solid rgb(210, 82, 225)');
        cy.get('div[class*="circle_small"]').find('p[class*="circle_letter"]').should('have.text', '44');
        ...
        cy.get('p[class*="circle_letter"]').eq(0).should('have.text', '0');
        cy.get('p[class*="circle_letter"]').eq(1).should('have.text', '44');
        cy.get('p[class*="circle_letter"]').eq(2).should('have.text', '34');
        cy.get('p[class*="circle_letter"]').eq(3).should('have.text', '8');
        cy.get('p[class*="circle_letter"]').eq(4).should('have.text', '1');

        cy.get('div[class*="circle_circle"]').eq(0).should('have.css', 'border', '4px solid rgb(0, 50, 255)');
        cy.get('div[class*="circle_circle"]').eq(1).should('have.css', 'border', '4px solid rgb(127, 224, 81)');
...
describe('Удаление элемента из head', function() {
    ...
    it('Элемент корректно удаляется из head', function() {
        ...
        cy.get('@item1').find('div[class*="circle_small"]').should('exist');
        cy.get('div[class*="circle_small"]').should('have.css', 'border', '4px solid rgb(210, 82, 225)')
        cy.get('div[class*="circle_small"]').find('p[class*="circle_letter"]').should('have.text', '0');
        cy.get('p[class*="circle_letter"]').eq(0).should('have.text', '');
        ...
        cy.get('li[class*="list-page_item"]').eq(0).as('item1');
        cy.get('li[class*="list-page_item"]').eq(2).as('item3');

        cy.get('p[class*="circle_index"]').eq(0).as('index1');
        cy.get('p[class*="circle_index"]').eq(1).as('index2');
        cy.get('p[class*="circle_index"]').eq(2).as('index3');
...
describe('Удаление элемента из tail', function() {
    ...
    it('Элемент корректно удаляется из tail', function() {
        ...
        cy.get('@item4').find('div[class*="circle_small"]').should('exist');
        cy.get('div[class*="circle_small"]').should('have.css', 'border', '4px solid rgb(210, 82, 225)')
        cy.get('div[class*="circle_small"]').find('p[class*="circle_letter"]').should('have.text', '1');
        cy.get('p[class*="circle_letter"]').eq(3).should('have.text', '');
...
describe('Удаление элемента по индексу', function() {
    ...
    it('Элемент корректно удаляется по индексу', function() {
        ...
        cy.get('div[class*="circle_circle"]').eq(0).should('have.css', 'border', '4px solid rgb(210, 82, 225)')
        cy.get('div[class*="circle_circle"]').eq(1).should('have.css', 'border', '4px solid rgb(210, 82, 225)')
        ...
        cy.get('@item2').find('div[class*="circle_small"]').should('exist');
        cy.get('div[class*="circle_small"]').should('have.css', 'border', '4px solid rgb(210, 82, 225)');
        cy.get('div[class*="circle_small"]').find('p[class*="circle_letter"]').should('have.text', '34');
        cy.get('p[class*="circle_letter"]').eq(1).should('have.text', '');
        ...
        cy.get('p[class*="circle_letter"]').eq(0).should('have.text', '0');
        cy.get('p[class*="circle_letter"]').eq(1).should('have.text', '8');
        cy.get('p[class*="circle_letter"]').eq(2).should('have.text', '1');
